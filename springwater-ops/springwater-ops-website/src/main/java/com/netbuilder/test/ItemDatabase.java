...
public class ItemDatabase {
	...
	static public void fillDatabase() {
		...
		itemList.add(new Item(
				...
				"Tool",
				"Spade"));
		itemList.get(0).addReview("gn0m3luvv3r", 3, "I was told that the Spear & Jackson Carbon Digging Spade would be microwave safe, but it turns out it does not fit in my microwave at all! Unless you have an industrial microwave, this may not be the spade for you");
		itemList.get(0).addReview("iGARDEN", 2, "It's alright but at the end of the day it's just a spade really...");
		itemList.get(0).addReview("xXspearjacksonXx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.add(new Item(
				"0002",
				...
				"Tool",
				"Spade"));
		itemList.get(1).addReview("spadeyboiii", 0, "It's not so hip to be square with this poorly crafted spade");
		itemList.get(1).addReview("luvmeshrubs", 0, "The worst spade I have ever purchased.");
		itemList.get(1).addReview("luvmeshrubs", 0, "Not good at all.");
		itemList.get(1).addReview("xXspearjacksonXx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.get(1).addReview("xXspearjackson2Xx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.get(1).addReview("xXspearjackson3Xx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.get(1).addReview("xXspearjackson4Xx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.get(1).addReview("xXspearjackson5Xx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.get(1).addReview("xXspearjackson6Xx", 5, "WOW. BRILLIANT. BEST SPADE EVER.");
		itemList.add(new Item(
				"0003",
				"Happy Gnome",
				11.99f,
				...
				"Gnome",
				"Gnome"));
		itemList.get(2).addReview("gn0meconnoisseur", 4 , "I give this gnome a 4/5");
		...
		itemList.add(new Item(
				...
				"Gnome",
				"Gnome"));
		itemList.get(3).addReview("gn0meconnoisseur", 5 , "I give this gnome a 5/5");
		...
		itemList.add(new Item(
				...
				"Gnome",
				"Gnome"));
		itemList.get(4).addReview("gn0meconnoisseur", 4 , "I give this gnome a 4/5");
		...
		itemList.add(new Item(
				...
				"Gnome",
				"Gnome"));
		itemList.get(5).addReview("gn0meconnoisseur", 3 , "I give this gnome a 3/5");
		itemList.get(5).addReview("wheelbarrowKING", 4 , "Wheely good");
		itemList.get(5).addReview("johnwheelbarrowman",5 , "Another top gnome to add to my wheelbarrow gnome collection.");
		itemList.add(new Item(
				"0007",
				"Gnome Triple Pack",
				4.99f,
				...
				"Gnome",
				"Gnome"));
		itemList.get(6).addReview("gn0meconnoisseur", 4 , "I give this gnome a 5/5");
		itemList.get(6).addReview("gnorman", 5 , "Three cheeky chaps, what could go wrong?!");
		itemList.get(6).addReview("pondLAD", 3 , "I lost one of my gnomes in the pond.");
		itemList.add(new Item(
				"0008",
				"Creepy Gnome",
				3.99f,
				...
				"Gnome",
				"Gnome"));
		itemList.get(7).addReview("gn0meconnoisseur", 0 , "I give this gnome a 0/5");
		...
		itemList.add(new Item(
				...
				"img/pot01.jpg",
				5,
				"A large brown pot made of only the finest clay.",
				"Pottery",
				"Pot"));
		...
		itemList.get(9).addReview("XxxxxxxPOTxxxxxxX", 5 , "Top pot for a top lad.");
		itemList.add(new Item(
				"0009",
				"Jacuzzi 5000",
				4999.99f,
				...
				"Furniture",
				"Jacuzzi"));
		itemList.get(10).addReview("fam0uslastw0rdz", 5 , "I think I will try the phone charger tonight. Wish me luck.");
		itemList.add(new Item(
				"0009",
				"Jacuzzi 5001",
				8999.99f,
				...
				"Furniture",
				"Jacuzzi"));
		itemList.get(10).addReview("loveAgoodDuck", 5 , "Doesn't come with a rubber duck. 0/5");
	}
