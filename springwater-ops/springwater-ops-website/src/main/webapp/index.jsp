        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="loginRegister.jsp">Action</a></li>
                ...
                <form class="navbar-form navbar-right" role="search">
                    ...
                    <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <a href="loginRegister.jsp"></a>Login</button>
                ...
                <div class="col-lg-8">
                    ...
                    <!-- ******************************** Create panel between carousel ************ -->
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item active"><a href="#"><center><img src="resources/img/gnome.jpg"><p>Gnome</p></img></center></a></div>
                        
                            <!-- Gnome Carousel Image -->
                            <div class="item"><a href="#"><center><img src="resources/img/gnome02.jpg" ahref="#"><p>Mushroom Gnome</p></img></center></a></div>
                            
                            <!-- Gnome Carousel Image -->
                            <div class="item"><a href="#"><center><img src="resources/img/gnome03.jpg" ahref="#"><p>Traveller Gnome</p></img></center></a></div>
                        </div>
        ...
        <div class="container">
            <div id="carousel-Most-Featured" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <!-- Gnome Carousel Image -->
                    <!-- <img data-src="holder.js/1140x500/auto/#777:#555/text:Garden Gnome" alt="First slide"> -->
                    <div class="item active"><a href="#"><center><img src="resources/img/gnome04.jpg" ahref="#"><p>Chelsea Flower Show Gnome</p></img></center></a></div>
                
                    <!-- Gnome Carousel Image -->
                    <div class="item"><a href="#"><center><img src="resources/img/gnome05.jpg" ahref="#"><p>En Libre Gnome</p></img></center></a>
                
                    <!-- Gnome Carousel Image -->
                    </div><div class="item"><a href="#"><center><img src="resources/img/gnome06.jpg" ahref="#"><p>Scarface Gnome</p></img></center></a></div>   
                </div>
        ...
        <div class="container">
            <div id="carousel-suggestions" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- Gnome Carousel Image -->
                    <!-- <img data-src="holder.js/1140x500/auto/#777:#555/text:Garden Gnome" alt="First slide"> -->
                    <div class="item active"><a href="#"><center><img src="resources/img/gnome.jpg" ahref="#"><p>Gnome</p></img></center></a></div>
