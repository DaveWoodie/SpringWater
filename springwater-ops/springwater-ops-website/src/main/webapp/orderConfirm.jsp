...
<body>
    ...
    <div class="jumbotron content">
        ...
        <!-- Order container -->
        <div class="container">
            <div style="text-align:right;padding-bottom:20px;padding-top:20px"><a href="index.jsp" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Continue</a></div>
            <!-- Order panel -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <p><b>Dispatched</b></p>
                            <img id="orderImage" src="resources/img/gnome.jpg">
                        </div>
